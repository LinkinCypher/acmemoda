...
$("body").append('<div class="fixed-button active"><a href="https://www.facebook.com/LinkinCypher" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Cristhian Mora</a> </div>');var $window=$(window),nav=$(".fixed-button");
